...
function Strategy(options, verify) {
  ...
  options.serviceUsername = options.serviceUsername;
  options.servicePassword = options.servicePassword;
  options.serviceLoginUrl = options.serviceLoginUrl;
...
Strategy.prototype.authorizationParams = function(options) {
  ...
  /*conn = new sf.Connection({
    loginUrl : options.serviceLoginUrl 
  });
  conn.login(options.serviceUsername, options.servicePassword, function(err, userInfo) {
  ...
  console.log("authorizationParams in ");
  var params = {};
